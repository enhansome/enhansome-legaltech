...
* [ContextGem](https://github.com/shcherbak-ai/contextgem) ⭐ 2,000 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - **\[Open Source]** Python framework for LLM-based extraction from legal and business documents with declarative concept/aspect schemas.
...
* [Juriscraper](https://github.com/freelawproject/juriscraper) ⭐ 632 | 🐛 279 | 🌐 HTML | 📅 2026-09-10 - **\[Open Source]** Python library for scraping US court websites (400+ courts, PACER).
* [Eyecite](https://github.com/freelawproject/eyecite) ⭐ 275 | 🐛 74 | 🌐 Python | 📅 2026-09-05 - **\[Open Source]** Legal citation extraction and analysis tool by Free Law Project.
* [AI Workdeck](https://github.com/zeweihan/aiworkdeck) ⭐ 132 | 🐛 16 | 🌐 Java | 📅 2026-09-11 - **\[Open Source]** AI-native IDE workspace for legal and document-heavy workflows — "VS Code for lawyers." Self-hosted (Java/Spring Boot + Vue + Electron + Docker, AGPLv3). Features MCP agent orchestration, OCR, due-diligence risk flagging, evidence-chain management, WPS WebOffice integration, and smart clipboard. Supports air-gapped deployment with Ollama + local storage.
...
* [ChatLaw](https://github.com/PKU-YuanGroup/ChatLaw) ⭐ 7,602 | 🐛 65 | 📅 2025-01-04 - **\[LLaMA/Ziya]** - **\[ZH]** - **\[CC BY-NC]** - Chinese legal LLM from Peking University; trained on 30K+ Chinese legal datasets
...
* [Pasal.id](https://github.com/ilhamfp/pasal) ⭐ 274 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-01 - **\[Claude + RAG]** - **\[ID]** - **\[Open]** - RAG-powered access to 40,000+ Indonesian regulations via Claude AI
...
* [Korean Law MCP](https://github.com/chrisryugj/korean-law-mcp) ⭐ 2,574 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - **\[🇰🇷 Korea]** 17 MCP tools wrapping 41 Korean government legal APIs; includes citation verification, impact graph, and time-travel diff.
* [SEC EDGAR MCP](https://github.com/stefanoamorelli/sec-edgar-mcp) ⭐ 357 | 🐛 36 | 🌐 Python | 📅 2026-08-21 - **\[🇺🇸 US]** MCP for SEC EDGAR filings, financial statements, and insider-trading data — useful for securities and corporate-disclosure workflows.
* [Pasal MCP](https://github.com/ilhamfp/pasal) ⭐ 274 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-01 - **\[🇮🇩 Indonesia]** MCP + REST + web app giving AI grounded access to 40k+ Indonesian regulations.
...
* [Mike](https://github.com/willchen96/mike) ⭐ 4,208 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-11 - **\[Open Source]** Legal document assistant (Next.js + Express + Supabase + S3/R2) that lets users chat with uploaded documents using Anthropic, Gemini, or OpenAI models; BYOK per user. Hosted at [mikeoss.com](https://mikeoss.com).
* [CourtListener (source)](https://github.com/freelawproject/courtlistener) ⭐ 1,011 | 🐛 1,047 | 🌐 Python | 📅 2026-09-11 - **\[Open Source]** Django source for the largest open US court-data archive (RECAP, opinions, oral arguments, judges) maintained by Free Law Project.
* [dd-agents](https://github.com/zoharbabin/due-diligence-agents) ⭐ 102 | 🐛 12 | 🌐 Python | 📅 2026-08-08 - **\[Open Source]** M\&A due diligence platform orchestrating 13 AI agents (Legal, Finance, Commercial, ProductTech, Cybersecurity, HR, Tax, Regulatory, ESG + Judge, Red Flag Scanner, Executive Synthesis, Acquirer Intelligence) across a 38-step pipeline. Interactive chat mode with 14 MCP tools for citation verification, cross-contract search, and document generation. Neurosymbolic cross-domain analysis routes findings between domains via deterministic rules. Apache 2.0, `pip install dd-agents`.
* [doc.haus](https://github.com/sure-scale/doc-haus) ⭐ 70 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-13 - **\[Open Source]** Self-hostable legal AI agent built as a fork of [OpenCode](https://github.com/anomalyco/opencode) ⭐ 206,636 | 🐛 5,753 | 🌐 TypeScript | 📅 2026-09-11; documents stay on the user's machine, with matter-scoped private workspaces, cited document Q\&A, and tracked-change DOCX redlines that open in Word.
...
* [LawGlance](https://github.com/lawglance/lawglance) ⭐ 322 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-08-26 - **\[Open Source]** Free RAG-based AI legal assistant with multi-jurisdictional knowledge bases.
...
* [Suffolk LIT Lab Assembly Line](https://github.com/SuffolkLITLab/docassemble-AssemblyLine) ⭐ 66 | 🐛 95 | 🌐 Python | 📅 2026-09-10 - **\[Open Source]** Toolkit for Massachusetts court forms; reusable pattern for any jurisdiction.
...
* [legal-redline-tools](https://github.com/evolsb/legal-redline-tools) ⭐ 57 | 🐛 3 | 🌐 Python | 📅 2026-07-23 - **\[Open Source]** Generates tracked-changes Word docs and redline PDFs from AI contract reviews.
...
* [OpenSign](https://github.com/OpenSignLabs/OpenSign) ⭐ 6,983 | 🐛 148 | 🌐 JavaScript | 📅 2026-08-21 - **\[Open Source]** Free open-source DocuSign alternative (Parse Server + React); 6.3k+ stars.
...
* [Clarvia](https://github.com/clarvia-org/clarvia-graph) ⭐ 12 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-10 - **\[Open Source]** Free, open-source bereavement compliance checklist for European families. Source-backed legal deadlines, multilingual, structured as a knowledge graph.
...
* [Open Legal-Answer Benchmark](https://github.com/Vaquill-AI/open-legal-answer-benchmark) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - **\[🇺🇸 US]** Reproducible benchmark of US legal-answer quality: a committed question set, a standard-library scorer, and deterministic metrics (must-include accuracy, citation-support rate) anyone can rerun. Data CC BY 4.0, code MIT. *(Sponsor)*
...
* [LKIF-Core](https://github.com/RinkeHoekstra/lkif-core) ⭐ 173 | 🐛 5 | 📅 2026-02-23 - Legal Knowledge Interchange Format; OWL ontology for basic legal concepts (norms, agents, documents, time). Foundation for many legal knowledge systems.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 504,999 | 🐛 106 | 📅 2026-09-02 - The original meta awesome list.
...
* [Jeryi-Sun/LLM-and-Law](https://github.com/Jeryi-Sun/LLM-and-Law) ⭐ 331 | 🐛 1 | 📅 2026-09-10 - Continually-updated paper list on LLMs applied to law.
