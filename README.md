...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 59 | 🐛 2 | 🌐 Python | 📅 2026-09-06 - 2M+ sections of US primary law (50-state statutory codes, the US Code, the CFR, and 52 constitutions) normalized to one schema, plus the scrapers that build it. On Hugging Face; CC BY 4.0 data / Apache-2.0 code; quarterly snapshots.
...
* [ContextGem](https://github.com/shcherbak-ai/contextgem) ⭐ 1,999 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - **\[Open Source]** Python framework for LLM-based extraction from legal and business documents with declarative concept/aspect schemas.
...
* [Juriscraper](https://github.com/freelawproject/juriscraper) ⭐ 631 | 🐛 277 | 🌐 HTML | 📅 2026-09-09 - **\[Open Source]** Python library for scraping US court websites (400+ courts, PACER).
* [Eyecite](https://github.com/freelawproject/eyecite) ⭐ 274 | 🐛 73 | 🌐 Python | 📅 2026-09-05 - **\[Open Source]** Legal citation extraction and analysis tool by Free Law Project.
...
* [S2ORC (Legal Subset)](https://github.com/allenai/s2orc) ⭐ 1,086 | 🐛 24 | 🌐 Python | 📅 2024-04-26 - **\[🌍 EN]** - **\[136M+]** - AllenAI's massive academic paper corpus containing deep legal reasoning/law review articles
...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 59 | 🐛 2 | 🌐 Python | 📅 2026-09-06 - **\[🇺🇸 EN]** - **\[2M+]** - 50-state statutory codes, the US Code, the CFR, and 52 constitutions normalized to one schema, plus the open scrapers that build it. On Hugging Face, CC BY 4.0 data / Apache-2.0 scrapers, quarterly snapshots. *(Sponsor)*
...
* [Lawyer-LLaMA](https://github.com/AndrewZhe/lawyer-llama) ⭐ 999 | 🐛 43 | 🌐 Python | 📅 2024-08-28 - **\[LLaMA-13B]** - **\[ZH]** - PKU's continually-pretrained Chinese legal model with judicial-exam and legal-consultation SFT data.
...
* [Korean Law MCP](https://github.com/chrisryugj/korean-law-mcp) ⭐ 2,570 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-08 - **\[🇰🇷 Korea]** 17 MCP tools wrapping 41 Korean government legal APIs; includes citation verification, impact graph, and time-travel diff.
...
* [adeu (Agentic DOCX Redlining Engine)](https://github.com/dealfluence/adeu) ⭐ 156 | 🐛 5 | 🌐 Python | 📅 2026-09-10 - MCP Server enabling LLMs to inject native Track Changes and Comments into Word documents.
...
* [Master Claude for Legal](https://github.com/sboghossian/master-claude-for-legal) ⭐ 64 | 🐛 1 | 📅 2026-05-18 - **\[Open Source]** - **\[MIT]** - Skill pack for legal teams using Claude with MCP connectors. 10 reference docs (privilege, verification, long documents, practice areas), 5 starter skills (NDA triage, version diff, meeting brief, citation verifier, status synthesis), 3 firm templates. Includes the source Anthropic legal-webinar transcript and 51-question dataset.
...
* [auslaw-mcp](https://github.com/russellbrenner/auslaw-mcp) ⭐ 35 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-10 - **\[🇦🇺 🇳🇿 AU/NZ]** MCP server searching AustLII case law and legislation with OCR for scanned PDFs.
...
* [law-scrapper-mcp](https://github.com/numikel/law-scrapper-mcp) ⭐ 20 | 🐛 5 | 🌐 Python | 📅 2026-09-08 - **\[🇵🇱 Poland]** MCP server for Polish legal acts via the Sejm API.
...
* [Sound Suite](https://github.com/alperu/soundsuite) ⭐ 3 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-09 - **\[Self-Hosted]** Local-first legal document intelligence platform exposing 14 MCP tools (semantic and keyword/hybrid search, OCR, exhibit image retrieval, and case-knowledge queries); watches case-file directories and indexes PDFs into a local vector store, running entirely on-premises with no external API calls. Source-available under the Polyform Noncommercial license.
...
* [keihyo-cases](https://github.com/eoylab/keihyo-cases) ⭐ 0 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-08 - **\[🇯🇵 Japan]** MCP server over Consumer Affairs Agency enforcement orders under the Act against Unjustifiable Premiums and Misleading Representations (景品表示法) — 措置命令 and 課徴金納付命令 — with the provisions cited in each order and a source URL on every record. Structured deterministically from the agency's own published pages; states explicitly that it contains no judgement of its own. Also JSON/JSONL/CSV. Data under the Public Data License 1.0, code MIT.
* [jftc-actions](https://github.com/eoylab/jftc-actions) ⭐ 0 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-08 - **\[🇯🇵 Japan]** MCP server over Japan Fair Trade Commission cease-and-desist orders (Antimonopoly Act) and Subcontract Act (取適法, formerly 下請法) recommendations, with a source URL per action. Personal names of sole proprietors are removed from the structured fields; unparsed announcements are kept in a separate file rather than filled in by guesswork. Data under the Public Data License 1.0, code MIT.
...
* [commercial-legal-pl](https://github.com/apiotrowski-afk/commercial-legal-pl) ⭐ 163 | 🐛 2 | 🌐 Python | 📅 2026-08-30 - **\[🇵🇱 Poland]** Skill for drafting and reviewing Polish-law B2B, IP, and IT contracts; ships a clause library and doctrinal knowledge base, with consistency checks for § / ust. / pkt cross-references. Works with Claude Code, Cursor, Codex, and other agent IDEs. Apache 2.0.
...
* [Mike](https://github.com/willchen96/mike) ⭐ 4,201 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-10 - **\[Open Source]** Legal document assistant (Next.js + Express + Supabase + S3/R2) that lets users chat with uploaded documents using Anthropic, Gemini, or OpenAI models; BYOK per user. Hosted at [mikeoss.com](https://mikeoss.com).
* [CourtListener (source)](https://github.com/freelawproject/courtlistener) ⭐ 1,011 | 🐛 1,041 | 🌐 Python | 📅 2026-09-10 - **\[Open Source]** Django source for the largest open US court-data archive (RECAP, opinions, oral arguments, judges) maintained by Free Law Project.
* [dd-agents](https://github.com/zoharbabin/due-diligence-agents) ⭐ 101 | 🐛 12 | 🌐 Python | 📅 2026-08-08 - **\[Open Source]** M\&A due diligence platform orchestrating 13 AI agents (Legal, Finance, Commercial, ProductTech, Cybersecurity, HR, Tax, Regulatory, ESG + Judge, Red Flag Scanner, Executive Synthesis, Acquirer Intelligence) across a 38-step pipeline. Interactive chat mode with 14 MCP tools for citation verification, cross-contract search, and document generation. Neurosymbolic cross-domain analysis routes findings between domains via deterministic rules. Apache 2.0, `pip install dd-agents`.
* [doc.haus](https://github.com/sure-scale/doc-haus) ⭐ 70 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-13 - **\[Open Source]** Self-hostable legal AI agent built as a fork of [OpenCode](https://github.com/anomalyco/opencode) ⭐ 206,294 | 🐛 5,734 | 🌐 TypeScript | 📅 2026-09-10; documents stay on the user's machine, with matter-scoped private workspaces, cited document Q\&A, and tracked-change DOCX redlines that open in Word.
...
* [Patron](https://github.com/matematicsolutions/patron) ⭐ 14 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-09 - **\[🇵🇱 Poland]** **\[Open Source]** Self-hosted AI agent for law firms; hard fork of Mike extended with a hash-chained audit trail (EU AI Act art. 12 record-keeping), bring-your-own-model, 9 language editions, and MCP connectors for Polish and EU primary law. AGPL-3.0.
...
* [Lex (i.AI)](https://github.com/i-dot-ai/lex) ⭐ 69 | 🐛 10 | 🌐 Python | 📅 2026-09-10 - **\[🇬🇧 UK]** Open UK legal API for AI agents and researchers from the UK Government's Incubator for AI.
...
* [Accord Project Template Archive](https://github.com/accordproject/template-archive) ⭐ 366 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-04 - **\[Open Source]** Smart legal contracts and templating system (Cicero / Concerto).

* [adeu](https://github.com/dealfluence/adeu) ⭐ 156 | 🐛 5 | 🌐 Python | 📅 2026-09-10 - **\[Open Source]** Agentic DOCX Redlining Engine for Word document Track Changes.
...
* [Suffolk LIT Lab Assembly Line](https://github.com/SuffolkLITLab/docassemble-AssemblyLine) ⭐ 66 | 🐛 95 | 🌐 Python | 📅 2026-09-08 - **\[Open Source]** Toolkit for Massachusetts court forms; reusable pattern for any jurisdiction.
...
* [Wraft](https://github.com/wraft/wraft) ⭐ 165 | 🐛 17 | 🌐 Elixir | 📅 2026-07-04 - **\[Open Source]** Document lifecycle management with version control.

* [legal-redline-tools](https://github.com/evolsb/legal-redline-tools) ⭐ 56 | 🐛 3 | 🌐 Python | 📅 2026-07-23 - **\[Open Source]** Generates tracked-changes Word docs and redline PDFs from AI contract reviews.

* [contract-review-agent](https://github.com/kipeum86/contract-review-agent) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-07-24 - **\[Open Source]** Local-first AI agent that turns contracts into clause-level analysis with tracked-change DOCX redlines.

* [Aakd](https://github.com/aaked-app/aakd) ⭐ 10 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-10 - **\[Open Source]** Self-hostable contract operations workspace for reviewing source-linked obligations, owners, deadlines, approvals, and completion evidence.
...
* [OpenSign](https://github.com/OpenSignLabs/OpenSign) ⭐ 6,976 | 🐛 148 | 🌐 JavaScript | 📅 2026-08-21 - **\[Open Source]** Free open-source DocuSign alternative (Parse Server + React); 6.3k+ stars.
...
* [LegalBench](https://github.com/HazyResearch/legalbench) ⭐ 634 | 🐛 20 | 🌐 Python | 📅 2026-03-30 - 162-task benchmark for English legal reasoning in LLMs. Live leaderboard maintained at [vals.ai](https://vals.ai).
...
* [LEXam](https://github.com/LEXam-Benchmark/LEXam) ⭐ 36 | 🐛 2 | 🌐 Python | 📅 2026-01-30 - **\[ICLR 2026]** Bilingual EN/DE law-school exam benchmark: 7,537 questions from 340 exams across 116 courses, mixing IRAC reasoning and MCQs.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 504,677 | 🐛 106 | 📅 2026-09-02 - The original meta awesome list.
...
* [Jeryi-Sun/LLM-and-Law](https://github.com/Jeryi-Sun/LLM-and-Law) ⭐ 331 | 🐛 1 | 📅 2026-09-09 - Continually-updated paper list on LLMs applied to law.
* [openlegaldata/awesome-legal-data](https://github.com/openlegaldata/awesome-legal-data) ⭐ 306 | 🐛 10 | 📅 2026-09-02 - Curated collection of legal text-processing datasets and resources.
