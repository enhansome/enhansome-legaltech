...
* [ContextGem](https://github.com/shcherbak-ai/contextgem) ⭐ 1,976 | 🐛 0 | 🌐 Python | 📅 2026-07-28 - **\[Open Source]** Python framework for LLM-based extraction from legal and business documents with declarative concept/aspect schemas.
...
* [Eyecite](https://github.com/freelawproject/eyecite) ⭐ 268 | 🐛 62 | 🌐 Python | 📅 2026-08-12 - **\[Open Source]** Legal citation extraction and analysis tool by Free Law Project.
...
* [Korean Law MCP](https://github.com/chrisryugj/korean-law-mcp) ⭐ 2,446 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-12 - **\[🇰🇷 Korea]** 17 MCP tools wrapping 41 Korean government legal APIs; includes citation verification, impact graph, and time-travel diff.
...
* [Mike](https://github.com/willchen96/mike) ⭐ 4,112 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-13 - **\[Open Source]** Legal document assistant (Next.js + Express + Supabase + S3/R2) that lets users chat with uploaded documents using Anthropic, Gemini, or OpenAI models; BYOK per user. Hosted at [mikeoss.com](https://mikeoss.com).
...
* [open-agreements](https://github.com/CommonAccord/Cmacc-Org) ⭐ 48 | 🐛 13 | 🌐 HTML | 📅 2026-08-13 - **\[Open Source]** CommonAccord: legal documents as structured, linkable data.
...
* [OpenSign](https://github.com/OpenSignLabs/OpenSign) ⭐ 6,809 | 🐛 139 | 🌐 JavaScript | 📅 2026-08-11 - **\[Open Source]** Free open-source DocuSign alternative (Parse Server + React); 6.3k+ stars.
...
* [LegalBench](https://github.com/HazyResearch/legalbench) ⭐ 622 | 🐛 19 | 🌐 Python | 📅 2026-03-30 - 162-task benchmark for English legal reasoning in LLMs. Live leaderboard maintained at [vals.ai](https://vals.ai).
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 495,126 | 🐛 100 | 📅 2026-06-30 - The original meta awesome list.
