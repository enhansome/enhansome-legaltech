...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2026-08-12 - 2M+ sections of US primary law (50-state statutory codes, the US Code, the CFR, and 52 constitutions) normalized to one schema, plus the scrapers that build it. On Hugging Face; CC BY 4.0 data / Apache-2.0 code; quarterly snapshots.
...
* [Vaquill AI for Word](https://github.com/Vaquill-AI/vaquill-word-addin) ⭐ 64 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-28 - Microsoft Word task-pane add-in for contract review, grounded redlining as native tracked changes, drafting, and US legal research. A community build runs standalone on your own OpenAI or Anthropic key. Apache-2.0.
...
* [ContextGem](https://github.com/shcherbak-ai/contextgem) ⭐ 1,982 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - **\[Open Source]** Python framework for LLM-based extraction from legal and business documents with declarative concept/aspect schemas.
...
* [Juriscraper](https://github.com/freelawproject/juriscraper) ⭐ 619 | 🐛 251 | 🌐 HTML | 📅 2026-08-13 - **\[Open Source]** Python library for scraping US court websites (400+ courts, PACER).
* [Eyecite](https://github.com/freelawproject/eyecite) ⭐ 268 | 🐛 64 | 🌐 Python | 📅 2026-08-12 - **\[Open Source]** Legal citation extraction and analysis tool by Free Law Project.
...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2026-08-12 - **\[🇺🇸 EN]** - **\[2M+]** - 50-state statutory codes, the US Code, the CFR, and 52 constitutions normalized to one schema, plus the open scrapers that build it. On Hugging Face, CC BY 4.0 data / Apache-2.0 scrapers, quarterly snapshots. *(Sponsor)*
...
* [Korean Law MCP](https://github.com/chrisryugj/korean-law-mcp) ⭐ 2,448 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-13 - **\[🇰🇷 Korea]** 17 MCP tools wrapping 41 Korean government legal APIs; includes citation verification, impact graph, and time-travel diff.
...
* [adeu (Agentic DOCX Redlining Engine)](https://github.com/dealfluence/adeu) ⭐ 136 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - MCP Server enabling LLMs to inject native Track Changes and Comments into Word documents.
...
* [Master Claude for Legal](https://github.com/sboghossian/master-claude-for-legal) ⭐ 55 | 🐛 1 | 📅 2026-05-18 - **\[Open Source]** - **\[MIT]** - Skill pack for legal teams using Claude with MCP connectors. 10 reference docs (privilege, verification, long documents, practice areas), 5 starter skills (NDA triage, version diff, meeting brief, citation verifier, status synthesis), 3 firm templates. Includes the source Anthropic legal-webinar transcript and 51-question dataset.
...
* [Mike](https://github.com/willchen96/mike) ⭐ 4,117 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-13 - **\[Open Source]** Legal document assistant (Next.js + Express + Supabase + S3/R2) that lets users chat with uploaded documents using Anthropic, Gemini, or OpenAI models; BYOK per user. Hosted at [mikeoss.com](https://mikeoss.com).
* [CourtListener (source)](https://github.com/freelawproject/courtlistener) ⭐ 988 | 🐛 1,003 | 🌐 Python | 📅 2026-08-13 - **\[Open Source]** Django source for the largest open US court-data archive (RECAP, opinions, oral arguments, judges) maintained by Free Law Project.
* [dd-agents](https://github.com/zoharbabin/due-diligence-agents) ⭐ 84 | 🐛 12 | 🌐 Python | 📅 2026-08-08 - **\[Open Source]** M\&A due diligence platform orchestrating 13 AI agents (Legal, Finance, Commercial, ProductTech, Cybersecurity, HR, Tax, Regulatory, ESG + Judge, Red Flag Scanner, Executive Synthesis, Acquirer Intelligence) across a 38-step pipeline. Interactive chat mode with 14 MCP tools for citation verification, cross-contract search, and document generation. Neurosymbolic cross-domain analysis routes findings between domains via deterministic rules. Apache 2.0, `pip install dd-agents`.
* [doc.haus](https://github.com/sure-scale/doc-haus) ⭐ 67 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-13 - **\[Open Source]** Self-hostable legal AI agent built as a fork of [OpenCode](https://github.com/anomalyco/opencode) ⭐ 197,284 | 🐛 5,195 | 🌐 TypeScript | 📅 2026-08-14; documents stay on the user's machine, with matter-scoped private workspaces, cited document Q\&A, and tracked-change DOCX redlines that open in Word.
...
* [Lex (i.AI)](https://github.com/i-dot-ai/lex) ⭐ 64 | 🐛 10 | 🌐 Python | 📅 2026-08-14 - **\[🇬🇧 UK]** Open UK legal API for AI agents and researchers from the UK Government's Incubator for AI.
...
* [adeu](https://github.com/dealfluence/adeu) ⭐ 136 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - **\[Open Source]** Agentic DOCX Redlining Engine for Word document Track Changes.

* [Suffolk LIT Lab Assembly Line](https://github.com/SuffolkLITLab/docassemble-AssemblyLine) ⭐ 65 | 🐛 102 | 🌐 Python | 📅 2026-08-13 - **\[Open Source]** Toolkit for Massachusetts court forms; reusable pattern for any jurisdiction.

* [Vaquill AI for Word](https://github.com/Vaquill-AI/vaquill-word-addin) ⭐ 64 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-28 - **\[Open Source]** Microsoft Word task-pane add-in for contract review, grounded redlining as native tracked changes, drafting, and US legal research. A community build runs standalone on your own OpenAI or Anthropic key. Apache-2.0. *(Sponsor)*
...
* [OpenSign](https://github.com/OpenSignLabs/OpenSign) ⭐ 6,811 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-11 - **\[Open Source]** Free open-source DocuSign alternative (Parse Server + React); 6.3k+ stars.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 495,518 | 🐛 100 | 📅 2026-06-30 - The original meta awesome list.
