...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 66 | 🐛 7 | 🌐 Python | 📅 2026-09-06 - 2M+ sections of US primary law (50-state statutory codes, the US Code, the CFR, and 52 constitutions) normalized to one schema, plus the scrapers that build it. On Hugging Face; CC BY 4.0 data / Apache-2.0 code; quarterly snapshots.
...
* [Vaquill MCP](https://github.com/Vaquill-AI/vaquill-mcp) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2026-09-19 - MCP server over US federal and 50-state law (USC, CFR, state legislation, CourtListener case law).
...
* [Juriscraper](https://github.com/freelawproject/juriscraper) ⭐ 641 | 🐛 294 | 🌐 HTML | 📅 2026-09-23 - **\[Open Source]** Python library for scraping US court websites (400+ courts, PACER).
* [Eyecite](https://github.com/freelawproject/eyecite) ⭐ 286 | 🐛 76 | 🌐 Python | 📅 2026-09-17 - **\[Open Source]** Legal citation extraction and analysis tool by Free Law Project.
* [AI Workdeck](https://github.com/zeweihan/aiworkdeck) ⭐ 148 | 🐛 16 | 🌐 Java | 📅 2026-09-24 - **\[Open Source]** AI-native IDE workspace for legal and document-heavy workflows — "VS Code for lawyers." Self-hosted (Java/Spring Boot + Vue + Electron + Docker, AGPLv3). Features MCP agent orchestration, OCR, due-diligence risk flagging, evidence-chain management, WPS WebOffice integration, and smart clipboard. Supports air-gapped deployment with Ollama + local storage.
* [Open Australian Legal Corpus Creator](https://github.com/isaacus-dev/open-australian-legal-corpus-creator) ⭐ 125 | 🐛 2 | 🌐 Python | 📅 2025-05-26 - **\[Open Source]** Scripts to build the open multijurisdictional corpus of Australian legislation and case law.
...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 66 | 🐛 7 | 🌐 Python | 📅 2026-09-06 - **\[🇺🇸 EN]** - **\[2M+]** - 50-state statutory codes, the US Code, the CFR, and 52 constitutions normalized to one schema, plus the open scrapers that build it. On Hugging Face, CC BY 4.0 data / Apache-2.0 scrapers, quarterly snapshots. *(Sponsor)*
...
* [ChatLaw](https://github.com/PKU-YuanGroup/ChatLaw) ⭐ 7,608 | 🐛 65 | 📅 2025-01-04 - **\[LLaMA/Ziya]** - **\[ZH]** - **\[CC BY-NC]** - Chinese legal LLM from Peking University; trained on 30K+ Chinese legal datasets
* [Lawyer-LLaMA](https://github.com/AndrewZhe/lawyer-llama) ⭐ 999 | 🐛 44 | 🌐 Python | 📅 2024-08-28 - **\[LLaMA-13B]** - **\[ZH]** - PKU's continually-pretrained Chinese legal model with judicial-exam and legal-consultation SFT data.
...
* [Korean Law MCP](https://github.com/chrisryugj/korean-law-mcp) ⭐ 2,608 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - **\[🇰🇷 Korea]** 17 MCP tools wrapping 41 Korean government legal APIs; includes citation verification, impact graph, and time-travel diff.
* [SEC EDGAR MCP](https://github.com/stefanoamorelli/sec-edgar-mcp) ⭐ 359 | 🐛 9 | 🌐 Python | 📅 2026-09-19 - **\[🇺🇸 US]** MCP for SEC EDGAR filings, financial statements, and insider-trading data — useful for securities and corporate-disclosure workflows.
...
* [adeu (Agentic DOCX Redlining Engine)](https://github.com/dealfluence/adeu) ⭐ 162 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - MCP Server enabling LLMs to inject native Track Changes and Comments into Word documents.
...
* [law-scrapper-mcp](https://github.com/numikel/law-scrapper-mcp) ⭐ 21 | 🐛 10 | 🌐 Python | 📅 2026-09-18 - **\[🇵🇱 Poland]** MCP server for Polish legal acts via the Sejm API.
...
* [EUR-Lex SPARQL MCP](https://github.com/matematicsolutions/mcp-eu-sparql) ⭐ 1 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-17 - **\[🇪🇺 EU]** MCP server querying the EU Publications Office SPARQL endpoint (EUR-Lex / Cellar) live: EU legislation plus 57k+ CJEU rulings, with CELEX and ECLI identifiers on every citation. MIT.
...
* [commercial-legal-pl](https://github.com/apiotrowski-afk/commercial-legal-pl) ⭐ 166 | 🐛 2 | 🌐 Python | 📅 2026-09-23 - **\[🇵🇱 Poland]** Skill for drafting and reviewing Polish-law B2B, IP, and IT contracts; ships a clause library and doctrinal knowledge base, with consistency checks for § / ust. / pkt cross-references. Works with Claude Code, Cursor, Codex, and other agent IDEs. Apache 2.0.
...
* [Mike](https://github.com/willchen96/mike) ⭐ 4,277 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-24 - **\[Open Source]** Legal document assistant (Next.js + Express + Supabase + S3/R2) that lets users chat with uploaded documents using Anthropic, Gemini, or OpenAI models; BYOK per user. Hosted at [mikeoss.com](https://mikeoss.com).
* [CourtListener (source)](https://github.com/freelawproject/courtlistener) ⭐ 1,032 | 🐛 1,049 | 🌐 Python | 📅 2026-09-24 - **\[Open Source]** Django source for the largest open US court-data archive (RECAP, opinions, oral arguments, judges) maintained by Free Law Project.
* [dd-agents](https://github.com/zoharbabin/due-diligence-agents) ⭐ 109 | 🐛 12 | 🌐 Python | 📅 2026-08-08 - **\[Open Source]** M\&A due diligence platform orchestrating 13 AI agents (Legal, Finance, Commercial, ProductTech, Cybersecurity, HR, Tax, Regulatory, ESG + Judge, Red Flag Scanner, Executive Synthesis, Acquirer Intelligence) across a 38-step pipeline. Interactive chat mode with 14 MCP tools for citation verification, cross-contract search, and document generation. Neurosymbolic cross-domain analysis routes findings between domains via deterministic rules. Apache 2.0, `pip install dd-agents`.
* [doc.haus](https://github.com/sure-scale/doc-haus) ⭐ 75 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-13 - **\[Open Source]** Self-hostable legal AI agent built as a fork of [OpenCode](https://github.com/anomalyco/opencode) ⭐ 209,789 | 🐛 6,178 | 🌐 TypeScript | 📅 2026-09-24; documents stay on the user's machine, with matter-scoped private workspaces, cited document Q\&A, and tracked-change DOCX redlines that open in Word.
...
* [Patron](https://github.com/matematicsolutions/patron) ⭐ 14 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-21 - **\[🇵🇱 Poland]** **\[Open Source]** Self-hosted AI agent for law firms; hard fork of Mike extended with a hash-chained audit trail (EU AI Act art. 12 record-keeping), bring-your-own-model, 9 language editions, and MCP connectors for Polish and EU primary law. AGPL-3.0.
...
* [Lex (i.AI)](https://github.com/i-dot-ai/lex) ⭐ 72 | 🐛 11 | 🌐 Python | 📅 2026-09-20 - **\[🇬🇧 UK]** Open UK legal API for AI agents and researchers from the UK Government's Incubator for AI.
...
* [Accord Project Template Archive](https://github.com/accordproject/template-archive) ⭐ 367 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-17 - **\[Open Source]** Smart legal contracts and templating system (Cicero / Concerto).

* [adeu](https://github.com/dealfluence/adeu) ⭐ 162 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - **\[Open Source]** Agentic DOCX Redlining Engine for Word document Track Changes.
...
* [Suffolk LIT Lab Assembly Line](https://github.com/SuffolkLITLab/docassemble-AssemblyLine) ⭐ 67 | 🐛 97 | 🌐 Python | 📅 2026-09-23 - **\[Open Source]** Toolkit for Massachusetts court forms; reusable pattern for any jurisdiction.
...
* [Wraft](https://github.com/wraft/wraft) ⭐ 167 | 🐛 18 | 🌐 Elixir | 📅 2026-07-04 - **\[Open Source]** Document lifecycle management with version control.
...
* [OpenSign](https://github.com/OpenSignLabs/OpenSign) ⭐ 7,026 | 🐛 153 | 🌐 JavaScript | 📅 2026-08-21 - **\[Open Source]** Free open-source DocuSign alternative (Parse Server + React); 6.3k+ stars.
...
* [MiCAR Whitepaper Linter](https://github.com/sebastianfoerste/micar-whitepaper-linter) ⭐ 0 | 🐛 5 | 🌐 Python | 📅 2026-09-19 - **\[🇪🇺 EU]** Deterministic linter for crypto-asset white papers under MiCAR (EU) 2023/1114: 35 rules mapped to Annex I-III with pinpoint citations, a CI action, and a browser playground.
...
* [LegalBench](https://github.com/HazyResearch/legalbench) ⭐ 639 | 🐛 21 | 🌐 Python | 📅 2026-03-30 - 162-task benchmark for English legal reasoning in LLMs. Live leaderboard maintained at [vals.ai](https://vals.ai).
...
* [LEXam](https://github.com/LEXam-Benchmark/LEXam) ⭐ 38 | 🐛 2 | 🌐 Python | 📅 2026-01-30 - **\[ICLR 2026]** Bilingual EN/DE law-school exam benchmark: 7,537 questions from 340 exams across 116 courses, mixing IRAC reasoning and MCQs.
...
* [Liquid Legal Institute — Legal Ontologies Registry](https://github.com/Liquid-Legal-Institute/Legal-Ontologies) ⭐ 195 | 🐛 2 | 📅 2024-03-30 - Curated, actively-maintained index of legal ontologies, schemas, and vocabularies (CC-BY-4.0).
* [LKIF-Core](https://github.com/RinkeHoekstra/lkif-core) ⭐ 175 | 🐛 5 | 📅 2026-02-23 - Legal Knowledge Interchange Format; OWL ontology for basic legal concepts (norms, agents, documents, time). Foundation for many legal knowledge systems.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 509,681 | 🐛 106 | 📅 2026-09-02 - The original meta awesome list.
...
* [Jeryi-Sun/LLM-and-Law](https://github.com/Jeryi-Sun/LLM-and-Law) ⭐ 333 | 🐛 1 | 📅 2026-09-18 - Continually-updated paper list on LLMs applied to law.
* [openlegaldata/awesome-legal-data](https://github.com/openlegaldata/awesome-legal-data) ⭐ 309 | 🐛 10 | 📅 2026-09-02 - Curated collection of legal text-processing datasets and resources.
