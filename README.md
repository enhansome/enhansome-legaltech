...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-08-15 - 2M+ sections of US primary law (50-state statutory codes, the US Code, the CFR, and 52 constitutions) normalized to one schema, plus the scrapers that build it. On Hugging Face; CC BY 4.0 data / Apache-2.0 code; quarterly snapshots.

**Benchmarks**

* [Open Legal-Answer Benchmark](https://github.com/Vaquill-AI/open-legal-answer-benchmark) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-07-18 - Reproducible benchmark of US legal-answer quality: a committed question set, a standard-library scorer, and deterministic metrics (must-include accuracy, citation-support rate) anyone can rerun. CC BY 4.0 / MIT.

**Add-ins & apps**

* [Vaquill AI for Word](https://github.com/Vaquill-AI/vaquill-word-addin) ⭐ 65 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-28 - Microsoft Word task-pane add-in for contract review, grounded redlining as native tracked changes, drafting, and US legal research. A community build runs standalone on your own OpenAI or Anthropic key. Apache-2.0.
* [Vaquill for Google Docs](https://github.com/Vaquill-AI/vaquill-google-docs-addon) ⭐ 3 | 🐛 0 | 🌐 Svelte | 📅 2026-07-10 - Google Docs sidebar add-on (Svelte 5 + Apps Script) for contract review, clause drafting and rewrite, and grounded chat, with native tracked-change redlines. Apache-2.0.

**MCP servers & integrations**

* [CanLII MCP](https://github.com/Vaquill-AI/canlii-mcp) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-09 - MCP server for the CanLII Canadian legal database with bring-your-own-key auth.
* [Vaquill MCP](https://github.com/Vaquill-AI/vaquill-mcp) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-08 - MCP server over US federal and 50-state law (USC, CFR, state legislation, CourtListener case law).
* [CourtListener MCP](https://github.com/Vaquill-AI/courtlistener-mcp) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2026-07-08 - MCP server for the CourtListener database (US federal/state courts, PACER, eCFR) with bring-your-own-key auth.
* [Vaquill Integrations](https://github.com/Vaquill-AI/integrations) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-09 - Chatbots (WhatsApp, Slack, Discord, Telegram, Teams), embeddable web widgets, a Chrome extension, and n8n workflows on the Vaquill API. MIT.
...
* [ContextGem](https://github.com/shcherbak-ai/contextgem) ⭐ 1,983 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - **\[Open Source]** Python framework for LLM-based extraction from legal and business documents with declarative concept/aspect schemas.
* [Blackstone](https://github.com/ICLRandD/Blackstone) ⭐ 696 | 🐛 13 | 🌐 Python | 📅 2024-07-16 - **\[Open Source]** 🇬🇧 spaCy NLP pipeline and model for unstructured UK legal text (NER, citations).
* [Juriscraper](https://github.com/freelawproject/juriscraper) ⭐ 621 | 🐛 260 | 🌐 HTML | 📅 2026-08-15 - **\[Open Source]** Python library for scraping US court websites (400+ courts, PACER).
* [Eyecite](https://github.com/freelawproject/eyecite) ⭐ 270 | 🐛 63 | 🌐 Python | 📅 2026-08-14 - **\[Open Source]** Legal citation extraction and analysis tool by Free Law Project.
* [Open Australian Legal Corpus Creator](https://github.com/isaacus-dev/open-australian-legal-corpus-creator) ⭐ 122 | 🐛 2 | 🌐 Python | 📅 2025-05-26 - **\[Open Source]** Scripts to build the open multijurisdictional corpus of Australian legislation and case law.
* [Opennyai](https://github.com/OpenNyAI/Opennyai) ⭐ 100 | 🐛 8 | 🌐 Python | 📅 2026-04-01 - **\[Open Source]** End-to-end Python NLP pipeline for Indian legal documents (NER, rhetorical-role labeling, summarization).
...
* [AI Workdeck](https://github.com/zeweihan/aiworkdeck) ⭐ 75 | 🐛 13 | 🌐 Java | 📅 2026-08-15 - **\[Open Source]** AI-native IDE workspace for legal and document-heavy workflows — "VS Code for lawyers." Self-hosted (Java/Spring Boot + Vue + Electron + Docker, AGPLv3). Features MCP agent orchestration, OCR, due-diligence risk flagging, evidence-chain management, WPS WebOffice integration, and smart clipboard. Supports air-gapped deployment with Ollama + local storage.
* [LegalCrawler](https://github.com/iliaschalkidis/LegalCrawler) ⭐ 64 | 🐛 2 | 🌐 Python | 📅 2022-08-18 - **\[Open Source]** Scripts to crawl and build English legal corpora from public court websites.
* [CiteURL](https://github.com/raindrum/citeurl) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-01-20 - **\[Open Source]** Extensible Python citation parser that turns US/UK/EU legal citations into hyperlinks; complements Eyecite with broader jurisdictional templates.
...
* [S2ORC (Legal Subset)](https://github.com/allenai/s2orc) ⭐ 1,081 | 🐛 23 | 🌐 Python | 📅 2024-04-26 - **\[🌍 EN]** - **\[136M+]** - AllenAI's massive academic paper corpus containing deep legal reasoning/law review articles
...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-08-15 - **\[🇺🇸 EN]** - **\[2M+]** - 50-state statutory codes, the US Code, the CFR, and 52 constitutions normalized to one schema, plus the open scrapers that build it. On Hugging Face, CC BY 4.0 data / Apache-2.0 scrapers, quarterly snapshots. *(Sponsor)*
...
* [ILDC (Indian Legal Documents Corpus)](https://github.com/Exploration-Lab/CJPE) ⭐ 110 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-02-10 - **\[🇮🇳 India]** - **\[EN]** - **\[34K cases]** - Court judgment prediction and explanation
...
* [LexGLUE](https://github.com/coastalcph/lex-glue) ⭐ 267 | 🐛 1 | 🌐 Python | 📅 2025-07-23 - **\[🌍 Multi]** - **\[EN]** - 7-task benchmark: EURLEX, ECHR, LEDGAR, SCOTUS, ContractNLI, CaseHOLD, ECtHR
...
* [IN-Abs / UK-Abs](https://github.com/Law-AI/summarization) ⭐ 225 | 🐛 5 | 🌐 Python | 📅 2022-11-09 - **\[🇮🇳 🇬🇧]** - **\[EN]** - Abstractive and extractive summarization datasets for Indian and UK case judgments
* [BillSum](https://github.com/FiscalNote/BillSum) ⭐ 71 | 🐛 19 | 🌐 Python | 📅 2023-08-14 - **\[🇺🇸 US]** - **\[EN]** - 22K US Congressional and California bill summaries
* [Multi-LexSum](https://github.com/multilexsum/dataset) ⭐ 23 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-12-15 - **\[🇺🇸 US]** - **\[EN]** - Multi-document summarization of US civil rights court cases
...
* [CLERC](https://github.com/neelguha/legal-ml-datasets) ⭐ 444 | 🐛 1 | 📅 2026-04-19 - **\[🇺🇸 US]** - **\[EN]** - Case Law Evaluation and Retrieval Corpus for dense retrieval
...
* [MAUD](https://github.com/TheAtticusProject/maud) ⭐ 100 | 🐛 3 | 🌐 Python | 📅 2023-02-15 - **\[🇺🇸 US]** - **\[EN]** - M\&A contract understanding; 39K questions on merger agreements
...
* [ChatLaw](https://github.com/PKU-YuanGroup/ChatLaw) ⭐ 7,571 | 🐛 65 | 📅 2025-01-04 - **\[LLaMA/Ziya]** - **\[ZH]** - **\[CC BY-NC]** - Chinese legal LLM from Peking University; trained on 30K+ Chinese legal datasets
* [Lawyer-LLaMA](https://github.com/AndrewZhe/lawyer-llama) ⭐ 1,000 | 🐛 32 | 🌐 Python | 📅 2024-08-28 - **\[LLaMA-13B]** - **\[ZH]** - PKU's continually-pretrained Chinese legal model with judicial-exam and legal-consultation SFT data.
* [DISC-LawLLM](https://github.com/FudanDISC/DISC-LawLLM) ⭐ 947 | 🐛 31 | 🌐 Python | 📅 2025-05-27 - **\[Baichuan 13B]** - **\[ZH]** - **\[Apache 2.0]** - Chinese legal assistant from Fudan; legal retrieval + reasoning
* [Fuzi.Mingcha](https://github.com/irlab-sdu/fuzi.mingcha) ⭐ 387 | 🐛 15 | 🌐 Python | 📅 2025-07-30 - **\[ChatGLM]** - **\[ZH]** - Judicial LLM from Shandong U. + China U. of Political Science & Law; statute retrieval, syllogistic reasoning, judicial dialogue.
* [Pasal.id](https://github.com/ilhamfp/pasal) ⭐ 266 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-01 - **\[Claude + RAG]** - **\[ID]** - **\[Open]** - RAG-powered access to 40,000+ Indonesian regulations via Claude AI
* [InternLM-Law](https://github.com/InternLM/InternLM-Law) ⭐ 17 | 🐛 4 | 📅 2024-05-14 - **\[InternLM2-Chat 7B]** - **\[ZH]** - **\[Apache 2.0]** - Shanghai AI Lab Chinese legal LLM SFT-tuned on \~1M legal examples; tops LawBench on 13/20 subtasks (COLING 2025).
...
* [LawBench Models](https://github.com/open-compass/LawBench) ⭐ 446 | 🐛 4 | 🌐 Python | 📅 2023-11-13 - **\[China]** - **\[ZH]** - Models evaluated on 20 Chinese legal tasks
...
* [Korean Law MCP](https://github.com/chrisryugj/korean-law-mcp) ⭐ 2,453 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-13 - **\[🇰🇷 Korea]** 17 MCP tools wrapping 41 Korean government legal APIs; includes citation verification, impact graph, and time-travel diff.
* [Yargı MCP](https://github.com/saidsurucu/yargi-mcp) ⭐ 1,096 | 🐛 1 | 🌐 Python | 📅 2026-08-06 - **\[🇹🇷 Turkey]** MCP server for Turkish legal databases (Yargıtay, Danıştay, Anayasa Mahkemesi).
* [SEC EDGAR MCP](https://github.com/stefanoamorelli/sec-edgar-mcp) ⭐ 349 | 🐛 37 | 🌐 Python | 📅 2026-08-12 - **\[🇺🇸 US]** MCP for SEC EDGAR filings, financial statements, and insider-trading data — useful for securities and corporate-disclosure workflows.
* [Pasal MCP](https://github.com/ilhamfp/pasal) ⭐ 266 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-01 - **\[🇮🇩 Indonesia]** MCP + REST + web app giving AI grounded access to 40k+ Indonesian regulations.
* [MCP Taiwan Legal DB](https://github.com/lawchat-oss/mcp-taiwan-legal-db) ⭐ 172 | 🐛 1 | 🌐 Python | 📅 2026-06-05 - **\[🇹🇼 Taiwan]** Taiwan Judicial Yuan judgments + national statute database via MCP.
* [adeu (Agentic DOCX Redlining Engine)](https://github.com/dealfluence/adeu) ⭐ 143 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - MCP Server enabling LLMs to inject native Track Changes and Comments into Word documents.
* [ayunis-legal-mcp](https://github.com/ayunis-core/ayunis-legal-mcp) ⭐ 86 | 🐛 1 | 🌐 Python | 📅 2026-08-05 - **\[🇩🇪 Germany]** MCP server exposing German legal codes (Gesetze-im-Internet).
* [Mahender22/legal-mcp](https://github.com/Mahender22/legal-mcp) ⭐ 63 | 🐛 0 | 🌐 Python | 📅 2026-06-19 - **\[🇺🇸 US]** 18 MCP tools across CourtListener case law (4M+ opinions, 400+ US courts), PACER federal filings, and Clio practice-management.
* [mcp-server-legifrance](https://github.com/pylegifrance/mcp-server-legifrance) ⭐ 63 | 🐛 2 | 🌐 Python | 📅 2025-06-29 - **\[🇫🇷 France]** MCP that wraps the official Légifrance/PISTE API for searching French statutes, codes, and judicial jurisprudence.
* [Master Claude for Legal](https://github.com/sboghossian/master-claude-for-legal) ⭐ 56 | 🐛 1 | 📅 2026-05-18 - **\[Open Source]** - **\[MIT]** - Skill pack for legal teams using Claude with MCP connectors. 10 reference docs (privilege, verification, long documents, practice areas), 5 starter skills (NDA triage, version diff, meeting brief, citation verifier, status synthesis), 3 firm templates. Includes the source Anthropic legal-webinar transcript and 51-question dataset.
* [auslaw-mcp](https://github.com/russellbrenner/auslaw-mcp) ⭐ 33 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-12 - **\[🇦🇺 🇳🇿 AU/NZ]** MCP server searching AustLII case law and legislation with OCR for scanned PDFs.
* [mcp-cerebra-legal-server](https://github.com/yoda-digital/mcp-cerebra-legal-server) ⭐ 33 | 🐛 3 | 🌐 TypeScript | 📅 2025-03-24 - MCP providing structured legal-reasoning tools (`legal_think`, follow-up, completion) with domain templates for contract, consumer-protection, and French procurement analysis.
* [Emilie](https://github.com/veronica-builds/emilie) ⭐ 31 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-04 - **\[🇨🇭 Switzerland]** Swiss sovereign legal AI; Mike fork extended with MCP client and local Apertus model support.
* [agentic-ops/legal-mcp](https://github.com/agentic-ops/legal-mcp) ⭐ 28 | 🐛 2 | 🌐 Python | 📅 2026-07-17 - Comprehensive MCP server for legal workflows. Integrates AI assistants with legal databases and case management systems (Clio, etc.).
* [droit-francais-mcp](https://github.com/jmtanguy/droit-francais-mcp) ⭐ 28 | 🐛 1 | 🌐 Python | 📅 2025-11-21 - **\[🇫🇷 France]** Unified MCP over Légifrance (legislation/codes/decrees) plus JudiLibre (case law) with PISTE-auth.
...
* [law-scrapper-mcp](https://github.com/numikel/law-scrapper-mcp) ⭐ 20 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - **\[🇵🇱 Poland]** MCP server for Polish legal acts via the Sejm API.
* [CourtListener MCP (Travis-Prall)](https://github.com/Travis-Prall/court-listener-mcp) ⭐ 12 | 🐛 2 | 🌐 Python | 📅 2026-02-01 - MCP Server for accessing CourtListener case data, court opinions, and eCFR federal regulations.
* [direito-familiar-imobiliario](https://github.com/maiconfuhr/direito-familiar-imobiliario) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-05-23 - **\[🇧🇷 Brazil]** **\[Claude Code Skill]** **\[pt-BR]** Civil-law skill orienting laypeople through real estate regularization (usucapião, REURB, matrícula), divorce (5 marital regimes, partilha, meação), and inheritance (inventário, ITCMD). Legislation current to May 2026 — includes Resolução CNJ 571/2024, Provimento CNJ 149/2023, LC 227/2026 (progressive ITCMD), Lei 14.711/2023 (Marco Legal das Garantias). Glossary (150+ terms), document checklists, interactive cost calculator, 75+ targeted questions for the attorney. MIT.
...
* [Vaquill AI MCP](https://github.com/vaquill-AI/vaquill-mcp) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-08 - MCP server that connects Claude / Cursor / Windsurf / VS Code to 8M+ US federal and state court opinions plus the US Code and CFR. *(Sponsor)*
* [Sound Suite](https://github.com/alperu/soundsuite) ⭐ 3 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-14 - **\[Self-Hosted]** Local-first legal document intelligence platform exposing 14 MCP tools (semantic and keyword/hybrid search, OCR, exhibit image retrieval, and case-knowledge queries); watches case-file directories and indexes PDFs into a local vector store, running entirely on-premises with no external API calls. Source-available under the Polyform Noncommercial license.
* [CourtListener MCP (khizar-anjum)](https://github.com/khizar-anjum/courtlistener-mcp) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-08 - MCP server built for searching cases by natural language legal problems across 3,352 U.S. courts.
* [SAOS MCP](https://github.com/matematicsolutions/mcp-saos) ⭐ 2 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-03 - **\[🇵🇱 Poland]** MCP server for Polish common and Supreme Court case law via the SAOS API, with verifiable citations. [Related connectors from the same maintainer](https://github.com/matematicsolutions) cover Polish administrative courts (NSA/CBOSA), procurement rulings (KIO), the company register (KRS), and tax interpretations (EUREKA). MIT.
...
* [Brazilian Law MCP](https://github.com/matematicsolutions/br-eli-mcp) ⭐ 1 | 🐛 1 | 🌐 Python | 📅 2026-08-07 - **\[🇧🇷 Brazil]** MCP server over 8 keyless open-data APIs for Brazilian law: Câmara and Senado bills and statutes, DataJud (CNJ), STJ and TST case law (3.75M labor-court rulings), and TCU / CARF administrative decisions, with verifiable citations. Apache-2.0.
* [EUR-Lex SPARQL MCP](https://github.com/matematicsolutions/mcp-eu-sparql) ⭐ 1 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-03 - **\[🇪🇺 EU]** MCP server querying the EU Publications Office SPARQL endpoint (EUR-Lex / Cellar) live: EU legislation plus 57k+ CJEU rulings, with CELEX and ECLI identifiers on every citation. MIT.
* [French Law MCP](https://github.com/Ansvar-Systems/French-law-mcp) ⚠️ Archived - **\[🇫🇷 France]** MCP exposing 3,958 French statutes (Code civil, Code pénal, Code du travail, Code de commerce, Loi I\&L) verified against official sources.
* [FilingFirehose MCP](https://filingfirehose.com) - **\[🇺🇸 US]** MCP + REST API over SEC EDGAR filings (8-K, 10-K, 10-Q, S-3) with red-flag risk scoring on top — going-concern, restatement, cyber (Item 1.05), officer departure, dilution. Companion open-source classifier at [buried-events-parser](https://github.com/jaablon/buried-events-parser) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-06-19 (MIT). Useful for continuous disclosure monitoring in M\&A due diligence and securities-litigation workflows.
...
* [EU Compliance MCP (offline)](https://github.com/matematicsolutions/mcp-eu-compliance) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-28 - **\[🇪🇺 EU]** Offline MCP corpus of EU law (GDPR, AI Act, DORA, NIS2, eIDAS 2.0, CRA): full text in a local SQLite FTS5 index, verbatim retrieval, no LLM in the loop; runs air-gapped. MIT.
* [CSOAI Legacy Bridges](https://github.com/CSOAI-ORG/cobol-bridge-mcp) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-06-26 - **\[🇪🇺 EU]** **\[Open Source]** Governed-MCP bridges that parse legacy-system payloads (COBOL, ISO-20022, HL7, SAP, SCADA) and check each action against EU AI Act, DORA, NIS2 and HIPAA, emitting an Ed25519-signed, offline-verifiable NIST OSCAL audit package (Article-12 evidence). 22 bridges plus a signed Layer-0 package validated under compliance-trestle.
...
* [Mike](https://github.com/willchen96/mike) ⭐ 4,125 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-15 - **\[Open Source]** Legal document assistant (Next.js + Express + Supabase + S3/R2) that lets users chat with uploaded documents using Anthropic, Gemini, or OpenAI models; BYOK per user. Hosted at [mikeoss.com](https://mikeoss.com).
* [CourtListener (source)](https://github.com/freelawproject/courtlistener) ⭐ 990 | 🐛 996 | 🌐 Python | 📅 2026-08-15 - **\[Open Source]** Django source for the largest open US court-data archive (RECAP, opinions, oral arguments, judges) maintained by Free Law Project.
* [dd-agents](https://github.com/zoharbabin/due-diligence-agents) ⭐ 85 | 🐛 12 | 🌐 Python | 📅 2026-08-08 - **\[Open Source]** M\&A due diligence platform orchestrating 13 AI agents (Legal, Finance, Commercial, ProductTech, Cybersecurity, HR, Tax, Regulatory, ESG + Judge, Red Flag Scanner, Executive Synthesis, Acquirer Intelligence) across a 38-step pipeline. Interactive chat mode with 14 MCP tools for citation verification, cross-contract search, and document generation. Neurosymbolic cross-domain analysis routes findings between domains via deterministic rules. Apache 2.0, `pip install dd-agents`.
* [doc.haus](https://github.com/sure-scale/doc-haus) ⭐ 67 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-13 - **\[Open Source]** Self-hostable legal AI agent built as a fork of [OpenCode](https://github.com/anomalyco/opencode) ⭐ 197,882 | 🐛 5,199 | 🌐 TypeScript | 📅 2026-08-16; documents stay on the user's machine, with matter-scoped private workspaces, cited document Q\&A, and tracked-change DOCX redlines that open in Word.
...
* [Legal Document Chat](https://github.com/janderswag/legal-document-chat) ⭐ 30 | 🐛 6 | 🌐 Python | 📅 2026-07-22 - **\[Open Source]** Self-hosted document chat for attorneys that parses legal PDFs and answers questions using local open-source LLMs (Ollama), with page- and span-level citations mechanically verified against the source; runs fully offline (loopback-only, no cloud calls) on FastAPI + LanceDB (MIT).
* [Patron](https://github.com/matematicsolutions/patron) ⭐ 10 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-10 - **\[🇵🇱 Poland]** **\[Open Source]** Self-hosted AI agent for law firms; hard fork of Mike extended with a hash-chained audit trail (EU AI Act art. 12 record-keeping), bring-your-own-model, 9 language editions, and MCP connectors for Polish and EU primary law. AGPL-3.0.
...
* [LawGlance](https://github.com/lawglance/lawglance) ⭐ 306 | 🐛 14 | 🌐 Jupyter Notebook | 📅 2026-08-16 - **\[Open Source]** Free RAG-based AI legal assistant with multi-jurisdictional knowledge bases.
* [OLAW (Harvard LIL)](https://github.com/harvard-lil/olaw) ⭐ 165 | 🐛 1 | 🌐 JavaScript | 📅 2024-10-29 - **\[Open Source]** Tool-based RAG workbench from Harvard Library Innovation Lab for legal AI UX research.
* [legal-tech-chat](https://github.com/tomasonjo-labs/legal-tech-chat) ⭐ 162 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2025-06-03 - **\[Open Source]** Reference pipeline: CUAD extraction → Neo4j knowledge graph → LangGraph agent.
* [Justicio](https://github.com/bukosabino/justicio) ⭐ 147 | 🐛 13 | 🌐 HTML | 📅 2024-07-17 - **\[🇪🇸 Spain]** RAG assistant over the Boletín Oficial del Estado (BOE).
* [GraphRAG Legal Cases](https://github.com/Azure-Samples/graphrag-legalcases-postgres) ⭐ 124 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2025-03-06 - **\[Open Source]** Legal-research copilot reference architecture using GraphRAG on PostgreSQL (Azure Samples).
* [Lex (i.AI)](https://github.com/i-dot-ai/lex) ⭐ 64 | 🐛 10 | 🌐 Python | 📅 2026-08-15 - **\[🇬🇧 UK]** Open UK legal API for AI agents and researchers from the UK Government's Incubator for AI.
...
* [Accord Project Template Archive](https://github.com/accordproject/template-archive) ⭐ 361 | 🐛 91 | 🌐 TypeScript | 📅 2026-08-06 - **\[Open Source]** Smart legal contracts and templating system (Cicero / Concerto).

* [adeu](https://github.com/dealfluence/adeu) ⭐ 143 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - **\[Open Source]** Agentic DOCX Redlining Engine for Word document Track Changes.

* [Suffolk LIT Lab Assembly Line](https://github.com/SuffolkLITLab/docassemble-AssemblyLine) ⭐ 65 | 🐛 101 | 🌐 Python | 📅 2026-08-14 - **\[Open Source]** Toolkit for Massachusetts court forms; reusable pattern for any jurisdiction.

* [Vaquill AI for Word](https://github.com/Vaquill-AI/vaquill-word-addin) ⭐ 65 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-28 - **\[Open Source]** Microsoft Word task-pane add-in for contract review, grounded redlining as native tracked changes, drafting, and US legal research. A community build runs standalone on your own OpenAI or Anthropic key. Apache-2.0. *(Sponsor)*

* [open-agreements](https://github.com/CommonAccord/Cmacc-Org) ⭐ 49 | 🐛 13 | 🌐 HTML | 📅 2026-08-15 - **\[Open Source]** CommonAccord: legal documents as structured, linkable data.

* [deslop](https://github.com/fayerman-source/deslop) ⭐ 13 | 🐛 0 | 📅 2026-06-25 - **\[Open Source]** Portable AI agent skill that rewrites legalese into plain English while preserving binding terms of art.

* [Vaquill for Google Docs](https://github.com/Vaquill-AI/vaquill-google-docs-addon) ⭐ 3 | 🐛 0 | 🌐 Svelte | 📅 2026-07-10 - **\[Open Source]** Google Docs sidebar add-on (Svelte 5 + Apps Script) for contract review, clause drafting and rewrite, and grounded chat, with native tracked-change redlines. Apache-2.0. *(Sponsor)*
...
* [Wraft](https://github.com/wraft/wraft) ⭐ 160 | 🐛 17 | 🌐 Elixir | 📅 2026-07-04 - **\[Open Source]** Document lifecycle management with version control.

* [legal-redline-tools](https://github.com/evolsb/legal-redline-tools) ⭐ 50 | 🐛 3 | 🌐 Python | 📅 2026-07-23 - **\[Open Source]** Generates tracked-changes Word docs and redline PDFs from AI contract reviews.

* [contract-review-agent](https://github.com/kipeum86/contract-review-agent) ⭐ 39 | 🐛 0 | 🌐 Python | 📅 2026-07-24 - **\[Open Source]** Local-first AI agent that turns contracts into clause-level analysis with tracked-change DOCX redlines.
...
* [OpenSign](https://github.com/OpenSignLabs/OpenSign) ⭐ 6,851 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-14 - **\[Open Source]** Free open-source DocuSign alternative (Parse Server + React); 6.3k+ stars.
...
* [ClinicCases](https://github.com/judsonmitchell/ClinicCases) ⚠️ Archived - **\[Open Source]** Case management for law school clinics.
...
* [Clarvia](https://github.com/clarvia-org/clarvia-graph) ⭐ 12 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-15 - **\[Open Source]** Free, open-source bereavement compliance checklist for European families. Source-backed legal deadlines, multilingual, structured as a knowledge graph.
...
* [LegalBench](https://github.com/HazyResearch/legalbench) ⭐ 625 | 🐛 19 | 🌐 Python | 📅 2026-03-30 - 162-task benchmark for English legal reasoning in LLMs. Live leaderboard maintained at [vals.ai](https://vals.ai).
* [LawBench](https://github.com/open-compass/LawBench) ⭐ 446 | 🐛 4 | 🌐 Python | 📅 2023-11-13 - 20-task Chinese legal benchmark evaluating LLMs across three cognitive levels.
* [maastrichtlawtech/awesome-legal-nlp](https://github.com/maastrichtlawtech/awesome-legal-nlp) ⭐ 337 | 🐛 5 | 📅 2025-10-14 - Curated list of Legal NLP resources, models, datasets, and papers.
* [LegalBench-RAG](https://github.com/zeroentropy-ai/legalbenchrag) ⭐ 202 | 🐛 3 | 🌐 Python | 📅 2025-05-30 - First retrieval benchmark for legal RAG: 6,858 expert-annotated query/span pairs over 79M characters of NDAs, M\&A agreements, commercial contracts, and privacy policies (arXiv:2408.10343).
* [prinzbench](https://github.com/prinz-ai/prinzbench) ⭐ 128 | 🐛 2 | 📅 2026-07-18 - Benchmark ranking LLMs on legal research and obscure-information retrieval.
* [LexEval](https://github.com/CSHaitao/LexEval) ⭐ 103 | 🐛 3 | 🌐 Python | 📅 2024-10-30 - **\[🇨🇳 ZH]** Comprehensive Chinese legal LLM benchmark: 14,150 questions across 23 tasks covering memorization, understanding, application, and ethics.
* [LRAGE](https://github.com/hoorangyee/LRAGE) ⭐ 79 | 🐛 1 | 🌐 Python | 📅 2026-07-03 - Framework for evaluating RAG pipelines specifically adapted for the legal domain.
* [LegalAgentBench](https://github.com/CSHaitao/LegalAgentBench) ⭐ 49 | 🐛 4 | 🌐 Python | 📅 2026-04-10 - LLM-agent benchmark in the Chinese legal domain: 17 real-world corpora, 37 tools, 300 annotated multi-hop reasoning + writing tasks (2024).
* [MLEB (source)](https://github.com/isaacus-dev/mleb) ⭐ 39 | 🐛 2 | 🌐 Python | 📅 2026-02-24 - Evaluation code for the multidomain MLEB leaderboard across 6 jurisdictions.
* [LEXam](https://github.com/LEXam-Benchmark/LEXam) ⭐ 33 | 🐛 2 | 🌐 Python | 📅 2026-01-30 - **\[ICLR 2026]** Bilingual EN/DE law-school exam benchmark: 7,537 questions from 340 exams across 116 courses, mixing IRAC reasoning and MCQs.
* [Open Legal-Answer Benchmark](https://github.com/Vaquill-AI/open-legal-answer-benchmark) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-07-18 - **\[🇺🇸 US]** Reproducible benchmark of US legal-answer quality: a committed question set, a standard-library scorer, and deterministic metrics (must-include accuracy, citation-support rate) anyone can rerun. Data CC BY 4.0, code MIT. *(Sponsor)*
...
* [Liquid Legal Institute — Legal Ontologies Registry](https://github.com/Liquid-Legal-Institute/Legal-Ontologies) ⭐ 190 | 🐛 2 | 📅 2024-03-30 - Curated, actively-maintained index of legal ontologies, schemas, and vocabularies (CC-BY-4.0).
* [LKIF-Core](https://github.com/RinkeHoekstra/lkif-core) ⭐ 167 | 🐛 5 | 📅 2026-02-23 - Legal Knowledge Interchange Format; OWL ontology for basic legal concepts (norms, agents, documents, time). Foundation for many legal knowledge systems.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 496,245 | 🐛 100 | 📅 2026-06-30 - The original meta awesome list.
* [maastrichtlawtech/awesome-legal-nlp](https://github.com/maastrichtlawtech/awesome-legal-nlp) ⭐ 337 | 🐛 5 | 📅 2025-10-14 - Legal NLP papers, models, and datasets.
* [Jeryi-Sun/LLM-and-Law](https://github.com/Jeryi-Sun/LLM-and-Law) ⭐ 325 | 🐛 1 | 📅 2026-08-14 - Continually-updated paper list on LLMs applied to law.
* [openlegaldata/awesome-legal-data](https://github.com/openlegaldata/awesome-legal-data) ⭐ 293 | 🐛 8 | 📅 2026-08-07 - Curated collection of legal text-processing datasets and resources.
