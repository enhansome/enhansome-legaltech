...
* [Juriscraper](https://github.com/freelawproject/juriscraper) ⭐ 636 | 🐛 295 | 🌐 HTML | 📅 2026-09-15 - **\[Open Source]** Python library for scraping US court websites (400+ courts, PACER).
...
* [Korean Law MCP](https://github.com/chrisryugj/korean-law-mcp) ⭐ 2,585 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-12 - **\[🇰🇷 Korea]** 17 MCP tools wrapping 41 Korean government legal APIs; includes citation verification, impact graph, and time-travel diff.
* [SEC EDGAR MCP](https://github.com/stefanoamorelli/sec-edgar-mcp) ⭐ 357 | 🐛 8 | 🌐 Python | 📅 2026-09-15 - **\[🇺🇸 US]** MCP for SEC EDGAR filings, financial statements, and insider-trading data — useful for securities and corporate-disclosure workflows.
...
* [MCP Taiwan Legal DB](https://github.com/lawchat-oss/mcp-taiwan-legal-db) ⭐ 191 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - **\[🇹🇼 Taiwan]** Taiwan Judicial Yuan judgments + national statute database via MCP.
* [adeu (Agentic DOCX Redlining Engine)](https://github.com/dealfluence/adeu) ⭐ 161 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - MCP Server enabling LLMs to inject native Track Changes and Comments into Word documents.
...
* [adeu](https://github.com/dealfluence/adeu) ⭐ 161 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - **\[Open Source]** Agentic DOCX Redlining Engine for Word document Track Changes.
...
* [legal-redline-tools](https://github.com/evolsb/legal-redline-tools) ⭐ 59 | 🐛 3 | 🌐 Python | 📅 2026-07-23 - **\[Open Source]** Generates tracked-changes Word docs and redline PDFs from AI contract reviews.
...
* [OpenSign](https://github.com/OpenSignLabs/OpenSign) ⭐ 7,000 | 🐛 150 | 🌐 JavaScript | 📅 2026-08-21 - **\[Open Source]** Free open-source DocuSign alternative (Parse Server + React); 6.3k+ stars.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 506,569 | 🐛 106 | 📅 2026-09-02 - The original meta awesome list.
...
* [Jeryi-Sun/LLM-and-Law](https://github.com/Jeryi-Sun/LLM-and-Law) ⭐ 331 | 🐛 1 | 📅 2026-09-15 - Continually-updated paper list on LLMs applied to law.
