...
* [Juriscraper](https://github.com/freelawproject/juriscraper) ⭐ 638 | 🐛 293 | 🌐 HTML | 📅 2026-09-18 - **\[Open Source]** Python library for scraping US court websites (400+ courts, PACER).
* [Eyecite](https://github.com/freelawproject/eyecite) ⭐ 280 | 🐛 74 | 🌐 Python | 📅 2026-09-17 - **\[Open Source]** Legal citation extraction and analysis tool by Free Law Project.
...
* [ChatLaw](https://github.com/PKU-YuanGroup/ChatLaw) ⭐ 7,605 | 🐛 65 | 📅 2025-01-04 - **\[LLaMA/Ziya]** - **\[ZH]** - **\[CC BY-NC]** - Chinese legal LLM from Peking University; trained on 30K+ Chinese legal datasets
...
* [InternLM-Law](https://github.com/InternLM/InternLM-Law) ⭐ 19 | 🐛 4 | 📅 2024-05-14 - **\[InternLM2-Chat 7B]** - **\[ZH]** - **\[Apache 2.0]** - Shanghai AI Lab Chinese legal LLM SFT-tuned on \~1M legal examples; tops LawBench on 13/20 subtasks (COLING 2025).
...
* [Korean Law MCP](https://github.com/chrisryugj/korean-law-mcp) ⭐ 2,591 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-12 - **\[🇰🇷 Korea]** 17 MCP tools wrapping 41 Korean government legal APIs; includes citation verification, impact graph, and time-travel diff.
...
* [MCP Taiwan Legal DB](https://github.com/lawchat-oss/mcp-taiwan-legal-db) ⭐ 192 | 🐛 1 | 🌐 Python | 📅 2026-09-17 - **\[🇹🇼 Taiwan]** Taiwan Judicial Yuan judgments + national statute database via MCP.
...
* [Mike](https://github.com/willchen96/mike) ⭐ 4,250 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-18 - **\[Open Source]** Legal document assistant (Next.js + Express + Supabase + S3/R2) that lets users chat with uploaded documents using Anthropic, Gemini, or OpenAI models; BYOK per user. Hosted at [mikeoss.com](https://mikeoss.com).
* [CourtListener (source)](https://github.com/freelawproject/courtlistener) ⭐ 1,026 | 🐛 1,052 | 🌐 Python | 📅 2026-09-18 - **\[Open Source]** Django source for the largest open US court-data archive (RECAP, opinions, oral arguments, judges) maintained by Free Law Project.
...
* [Lex (i.AI)](https://github.com/i-dot-ai/lex) ⭐ 69 | 🐛 10 | 🌐 Python | 📅 2026-09-18 - **\[🇬🇧 UK]** Open UK legal API for AI agents and researchers from the UK Government's Incubator for AI.
...
* [OpenSign](https://github.com/OpenSignLabs/OpenSign) ⭐ 7,007 | 🐛 151 | 🌐 JavaScript | 📅 2026-08-21 - **\[Open Source]** Free open-source DocuSign alternative (Parse Server + React); 6.3k+ stars.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 507,334 | 🐛 106 | 📅 2026-09-02 - The original meta awesome list.
...
* [Jeryi-Sun/LLM-and-Law](https://github.com/Jeryi-Sun/LLM-and-Law) ⭐ 331 | 🐛 1 | 📅 2026-09-17 - Continually-updated paper list on LLMs applied to law.
