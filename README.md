...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-08-15 - 2M+ sections of US primary law (50-state statutory codes, the US Code, the CFR, and 52 constitutions) normalized to one schema, plus the scrapers that build it. On Hugging Face; CC BY 4.0 data / Apache-2.0 code; quarterly snapshots.
...
* [Juriscraper](https://github.com/freelawproject/juriscraper) ⭐ 623 | 🐛 256 | 🌐 HTML | 📅 2026-08-19 - **\[Open Source]** Python library for scraping US court websites (400+ courts, PACER).
* [Eyecite](https://github.com/freelawproject/eyecite) ⭐ 270 | 🐛 64 | 🌐 Python | 📅 2026-08-14 - **\[Open Source]** Legal citation extraction and analysis tool by Free Law Project.
...
* [Open US Law](https://github.com/Vaquill-AI/open-us-law) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-08-15 - **\[🇺🇸 EN]** - **\[2M+]** - 50-state statutory codes, the US Code, the CFR, and 52 constitutions normalized to one schema, plus the open scrapers that build it. On Hugging Face, CC BY 4.0 data / Apache-2.0 scrapers, quarterly snapshots. *(Sponsor)*
...
* [ChatLaw](https://github.com/PKU-YuanGroup/ChatLaw) ⭐ 7,576 | 🐛 65 | 📅 2025-01-04 - **\[LLaMA/Ziya]** - **\[ZH]** - **\[CC BY-NC]** - Chinese legal LLM from Peking University; trained on 30K+ Chinese legal datasets
...
* [Korean Law MCP](https://github.com/chrisryugj/korean-law-mcp) ⭐ 2,486 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-19 - **\[🇰🇷 Korea]** 17 MCP tools wrapping 41 Korean government legal APIs; includes citation verification, impact graph, and time-travel diff.
...
* [adeu (Agentic DOCX Redlining Engine)](https://github.com/dealfluence/adeu) ⭐ 149 | 🐛 2 | 🌐 Python | 📅 2026-08-18 - MCP Server enabling LLMs to inject native Track Changes and Comments into Word documents.
...
* [law-scrapper-mcp](https://github.com/numikel/law-scrapper-mcp) ⭐ 20 | 🐛 13 | 🌐 Python | 📅 2026-08-19 - **\[🇵🇱 Poland]** MCP server for Polish legal acts via the Sejm API.
...
* [Sound Suite](https://github.com/alperu/soundsuite) ⭐ 3 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-19 - **\[Self-Hosted]** Local-first legal document intelligence platform exposing 14 MCP tools (semantic and keyword/hybrid search, OCR, exhibit image retrieval, and case-knowledge queries); watches case-file directories and indexes PDFs into a local vector store, running entirely on-premises with no external API calls. Source-available under the Polyform Noncommercial license.
...
* [commercial-legal-pl](https://github.com/apiotrowski-afk/commercial-legal-pl) ⭐ 154 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - **\[🇵🇱 Poland]** Skill for drafting and reviewing Polish-law B2B, IP, and IT contracts; ships a clause library and doctrinal knowledge base, with consistency checks for § / ust. / pkt cross-references. Works with Claude Code, Cursor, Codex, and other agent IDEs. Apache 2.0.
...
* [Mike](https://github.com/willchen96/mike) ⭐ 4,138 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-20 - **\[Open Source]** Legal document assistant (Next.js + Express + Supabase + S3/R2) that lets users chat with uploaded documents using Anthropic, Gemini, or OpenAI models; BYOK per user. Hosted at [mikeoss.com](https://mikeoss.com).
* [CourtListener (source)](https://github.com/freelawproject/courtlistener) ⭐ 993 | 🐛 998 | 🌐 Python | 📅 2026-08-20 - **\[Open Source]** Django source for the largest open US court-data archive (RECAP, opinions, oral arguments, judges) maintained by Free Law Project.
...
* [adeu](https://github.com/dealfluence/adeu) ⭐ 149 | 🐛 2 | 🌐 Python | 📅 2026-08-18 - **\[Open Source]** Agentic DOCX Redlining Engine for Word document Track Changes.
...
* [Wraft](https://github.com/wraft/wraft) ⭐ 162 | 🐛 17 | 🌐 Elixir | 📅 2026-07-04 - **\[Open Source]** Document lifecycle management with version control.
...
* [OpenSign](https://github.com/OpenSignLabs/OpenSign) ⭐ 6,882 | 🐛 144 | 🌐 JavaScript | 📅 2026-08-19 - **\[Open Source]** Free open-source DocuSign alternative (Parse Server + React); 6.3k+ stars.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 497,927 | 🐛 104 | 📅 2026-08-18 - The original meta awesome list.
...
* [Jeryi-Sun/LLM-and-Law](https://github.com/Jeryi-Sun/LLM-and-Law) ⭐ 327 | 🐛 1 | 📅 2026-08-14 - Continually-updated paper list on LLMs applied to law.
* [openlegaldata/awesome-legal-data](https://github.com/openlegaldata/awesome-legal-data) ⭐ 295 | 🐛 6 | 📅 2026-08-17 - Curated collection of legal text-processing datasets and resources.
